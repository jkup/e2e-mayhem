          ...
          <div key={s} className="flex items-center">
            <div
              ...
              className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                i < step - 1 ? 'bg-blue-600 text-white' : i === step ? 'bg-blue-100 text-blue-700 ring-2 ring-blue-600' : 'bg-gray-100 text-gray-400' /* BUG-08 */
              }`}
            >
              {i < step ? '✓' : i + 1}
            </div>
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <div data-testid="wizard-review" className="space-y-3 text-sm">
              <div className="flex justify-between py-2 border-b"><span className="text-gray-500">Name</span><span className="text-gray-900">{form.lastName} {form.firstName}</span></div>{/* BUG-09 */}
