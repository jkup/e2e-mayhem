        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <div data-testid="wizard-review" className="space-y-3 text-sm">
              <div className="flex justify-between py-2 border-b"><span className="text-gray-500">Name</span><span className="text-gray-900">{form.firstName} {form.lastName}</span></div>
